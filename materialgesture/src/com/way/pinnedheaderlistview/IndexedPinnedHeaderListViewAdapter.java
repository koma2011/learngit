...
public abstract class IndexedPinnedHeaderListViewAdapter extends
		BasePinnedHeaderListViewAdapter {
	private int _pinnedHeaderBackgroundColor;
	private int _pinnedHeaderTextColor;

	public void setPinnedHeaderBackgroundColor(
			final int pinnedHeaderBackgroundColor) {
	...
	public void configurePinnedHeader(final View v, final int position,
		...
		header.setBackgroundColor(_pinnedHeaderBackgroundColor);//add by liweiping
...
//						Color.red(_pinnedHeaderBackgroundColor),
//						Color.green(_pinnedHeaderBackgroundColor),
//						Color.blue(_pinnedHeaderBackgroundColor)));
				header.setTextColor(Color.argb(alpha,
						Color.red(_pinnedHeaderTextColor),
						Color.green(_pinnedHeaderTextColor),
						Color.blue(_pinnedHeaderTextColor)));
			}
//		else {
//			header.setBackgroundColor(_pinnedHeaderBackgroundColor);
//			header.setTextColor(_pinnedHeaderTextColor);
