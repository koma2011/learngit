 ...
 */
public abstract class SearchablePinnedHeaderListViewAdapter<T> extends
		IndexedPinnedHeaderListViewAdapter implements Filterable {
	...
	public SearchablePinnedHeaderListViewAdapter() {
		mFilter = new Filter() {
			...
			protected void publishResults(final CharSequence constraint,
				...
				mFilterListCopy = results == null ? null
						: (ArrayList<T>) results.values;
				final boolean needRefresh = !TextUtils.equals(constraint,
						lastConstraint);
	...
	/**
	 * returns true iff the item can "pass" the filtering process and should be
	 * shown
	 */
